...
<meta name="keywords" content="Resort Inn Responsive , Smartphone Compatible web template , Vivo, LG, Sony Ericsson, Motorola web design" />
...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					...
					<li><i class="fa fa-phone" aria-hidden="true"></i>+91 (97)310-40-825</li>	
					<li class="s-bar">
						<div class="search">
			...
			<div id="horizontalTab">
					...
					<div class="tab1">
						...
						<div class="col-md-6 team-Info-agileits">
							<h4>Pavan Kumar</h4>
							<span>Creator And Editor</span>
							<p>He is a Creater and Editor.Studying in 6th Sem Computer Science in Govt Polytechnic Soraba.He is From Hosanagara .</p>
					...
					<div class="col-md-6 team-img-w3-agile">
						...
						<div class="col-md-6 team-Info-agileits">
							...
							<p>She is helper and member.she is studiying in 6th Sem Computer Science.Govt Polytechnic Soraba  .</p>	
						<div class="social-bnr-agileits footer-icons-agileinfo">
							<ul class="social-icons3">
								<li><a href="#" class="fa fa-facebook icon-border facebook"> </a></li>
								<li><a href="#" class="fa fa-twitter icon-border twitter"> </a></li>
					...
					<div class="tab3">
						...
						<div class="col-md-6 team-Info-agileits">
							<h4>Sindhu B H</h4>
							<span>Helper</span>
							<p>She is helper and member.Studying in 6th Sem Computer Science.Govt Polytechnic Soraba.</p>
						<div class="social-bnr-agileits footer-icons-agileinfo">
							<ul class="social-icons3">
								<li><a href="#" class="fa fa-facebook icon-border facebook"> </a></li>
								<li><a href="#" class="fa fa-twitter icon-border twitter"> </a></li>
					...
					<div class="col-md-6 team-img-w3-agile">
						...
						<div class="col-md-6 team-Info-agileits">
							<h4>Sushma P</h4>
							<span>Sponsor</span>
							<p>She is sponsor and Member.Studying in 6th Sem computer Science.Govt Polytechnic Soraba.</p>
						<div class="social-bnr-agileits footer-icons-agileinfo">
							<ul class="social-icons3">
								<li><a href="#" class="fa fa-facebook icon-border facebook"> </a></li>
								<li><a href="#" class="fa fa-twitter icon-border twitter"> </a></li>
					...
					<ul class="slides">
						<li>
							...
							<div class="w3layouts_work_grid_right">
								...
								<p>You are Hotel is the one of the best Hotel.Best wether and Rooms. </p>
								<h5>Julia Rose</h5>
								<p>Germany</p>
							</div>
							<div class="clearfix"> </div>
						...
						<li>
							...
							<div class="w3layouts_work_grid_right">
								...
								<p>You are Hotel is very clean and super.I will defnetly come again </p>
						...
						<li>
							...
							<div class="w3layouts_work_grid_right">
								...
								<p>Your Hotel is very clean and Good rooms and Super Wether. </p>
						...
						<li>
							...
							<div class="w3layouts_work_grid_right">
								...
								<p>hotel is super and fresh food i wiil like. </p>
								<h5>Amie Bublitz</h5>
								<p>Switzerland</p>
							</div>
							<div class="clearfix"> </div>
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>+91 (97)310-40-825</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:name@example.com">INFO@SUNRISE.COM</a></p>
			<p class="contact-agile1"><strong>Address :</strong> Main Road, 3rd Circle, Hosanagara</p>
